angular.module('starter.services', [])
  ...
  .factory('$calendar',function(){
    var calendar={
      ...
      nStr2:['初','十','廿','卅'],
      sFtv:[
        "0101 元旦", "0214 情人节", "0308 妇女节","0401 愚人节", "0501 劳动节", "0504 青年节", "0601 儿童节", "0910 教师节", "1001 国庆节","1031 万圣节","1224 平安夜", "1225 圣诞节"
      ],
      lFtv:[
        "0101 春节", "0115 元宵节", "0505 端午节", "0707 七夕节", "0715 中元节", "0815 中秋节", "0909 重阳节", "1208 腊八节", "1223 小年"
      ],
      // jFtv:{
      //   2018:{1:['1','10','11','13']}
      // },
    ...
    sTermInfo:['9778397bd097c36b0b6fc9274c91aa','97b6b97bd19801ec9210c965cc920e','97bcf97c3598082c95f8c965cc920f',
      ...
      //记录公历和农历某天的日期
      calElement:function(sYear,sMonth,sDay,week,lYear,lMonth,lDay,isLeap) {
        this.isToday = false;
        //公历
        this.sYear = sYear;
        this.sMonth = sMonth;
      ...
      calendar:function(y,m) {
        ...
        for(var i=0;i<this.length;i++) {
          if(lD>lX) {
            ...
            if (lM==12){this.eve=lX}
            if(n==0) firstLM = lM;
            lDPOS[n++] = i-lD+1;
          }
          this.calElement(y,m+1,i+1,this.nStr1[(i+this.firstWeek)%7],lY,lM,lD++,lL);
          var me=this;
          this[i] ={
            isToday : false,
            //公历
        ...
        if(y==this.tY && m==this.tM) {
          this[this.tD-1].isToday = true;this.isToday = true;
        }else{
          this.isToday=false;
        }
        //今日
      ...
      drawCld:function (SY,SM) {
        ...
        for(i=0;i<42;i++) {
          ...
          if(sD>-1 && sD<this.length) { //日期内
            ...
            if(this[sD].lDay==1){ //显示农历月(不显示日)
              dayDetail.nlr= (this[sD].isLeap?'闰':'') + this[sD].lMonth + '月' + (this.monthDays(this[sD].lYear,this[sD].lMonth)==29?'小':'大');
            } else{
              dayDetail.nlr= this.cDay(Math.round(this[sD].lDay));
            }//显示农历日
            var Slfw=Ssfw=null;
            s=this[sD].solarFestival;
            for (var ipp=0;ipp<this.lFtv.length;ipp++){	//农历节日
              if (parseInt(this.lFtv[ipp].substr(0,2))==(this[sD].lMonth)){
                if (parseInt(this.lFtv[ipp].substr(2,4))==(Math.round(this[sD].lDay))){
                  dayDetail.nlr=this.lFtv[ipp].substr(5);
                  dayDetail.color='#DA4C39';
                  Slfw=this.lFtv[ipp].substr(5);
                }
              }
              if (12==(this[sD].lMonth)){	//判断是否为除夕
                if (this.eve==(this[sD].lDay)){
                  dayDetail.nlr="除夕";Slfw="除夕";
                  dayDetail.color='#DA4C39';
                }
              }
            }
            for (var ipp=0;ipp<this.sFtv.length;ipp++){	//公历节日
            ...
            if ((SM+1)==5){	//母亲节
              if (this.fat==0){
                if ((sD+1)==7){Ssfw="母亲节";dayDetail.nlr="母亲节";dayDetail.color='#6CC1AD';}
              }
              else if (this.fat<9){
                if ((sD+1)==((7-this.fat)+8)){Ssfw="母亲节";dayDetail.nlr="母亲节";dayDetail.color='#6CC1AD';}
              }
            }
            if ((SM+1)==6){	//父亲节
              if (this.mat==0){
                if ((sD+1)==14){Ssfw="父亲节";dayDetail.nlr="父亲节";dayDetail.color='#6CC1AD';}
              }
              else if (this.mat<9){
                if ((sD+1)==((7-this.mat)+15)){Ssfw="父亲节";dayDetail.nlr="父亲节";dayDetail.color='#6CC1AD';}
              }
            }
            ...
            if(s.length>0) {
              ...
              if(nlrfirst != '初'&&nlrfirst != '十'&&nlrfirst != '廿'&&nlrfirst != '二'&&nlrfirst != '三'&&nlrfirst != '卅'){
                dayDetail.nlr+='/'+s;
              }else{
                dayDetail.nlr=s;
              }
              dayDetail.color='#EEAE44';Slfw=s;
            }	//节气
        ...
        if((this.sYear <= dateYear && this.sMonth < dateMonth) || (this.sYear < dateYear)){
          for(var i=0;i<dayList.length;i++){
    ...
    drawCldNew:function (SY,SM) {
      ...
      for(i=0;i<42;i++) {
        ...
        if(sD>-1 && sD<this.length) { //日期内
          ...
          if(s.length>0) {dayDetail.nlr=s;dayDetail.color='#EEAE44';Slfw=s;}	//节气
          if ((Slfw!=null)&&(Ssfw!=null)){
            dayDetail.nlr=Slfw+"/"+Ssfw;
            dayDetail.color='#EEAE44';
          }
    ...
    sTermInfo:['9778397bd097c36b0b6fc9274c91aa','97b6b97bd19801ec9210c965cc920e','97bcf97c3598082c95f8c965cc920f',
      ...
      drawCld:function (SY,SM,luckyDay,isLuckyDay) {
        ...
        for(i=0;i<42;i++) {
          ...
          if(sD>-1 && sD<this.length) { //日期内
            ...
            for (var ipp=0;ipp<this.lFtv.length;ipp++){	//农历节日
              ...
              if (12==(this[sD].lMonth)&&isLuckyDay==0){	//判断是否为除夕
                if (this.eve==(this[sD].lDay)){
                  dayDetail.nlr="除夕";Slfw="除夕";
                  if(isLuckyDay==0){
                    dayDetail.color='#DA4C39';
            ...
            if ((SM+1)==5){	//母亲节
              if (this.fat==0){
                if ((sD+1)==7){Ssfw="母亲节";dayDetail.nlr="母亲节";if(isLuckyDay==0){dayDetail.color='#6CC1AD';}}
              }
              else if (this.fat<9){
                if ((sD+1)==((7-this.fat)+8)){Ssfw="母亲节";dayDetail.nlr="母亲节";if(isLuckyDay==0){dayDetail.color='#6CC1AD';}}
              }
            }
            if ((SM+1)==6){	//父亲节
              if (this.mat==0){
                if ((sD+1)==14){Ssfw="父亲节";dayDetail.nlr="父亲节";if(isLuckyDay==0){dayDetail.color='#6CC1AD';}}
              }
              else if (this.mat<9){
                if ((sD+1)==((7-this.mat)+15)){Ssfw="父亲节";dayDetail.nlr="父亲节";if(isLuckyDay==0){dayDetail.color='#6CC1AD';}}
              }
            }
            if (s.length<=0){	//设置节气的颜色
              s=this[sD].solarTerms;
            ...
            if(s.length>0) {
              ...
              if(isLuckyDay==0){dayDetail.color='#EEAE44'};Slfw=s;
            }	//节气
            if ((Slfw!=null)&&(Ssfw!=null)){
              dayDetail.nlr=Slfw+"/"+Ssfw;
              if(isLuckyDay==0){dayDetail.color='#EEAE44';}
            }
          }
          else { //非日期
            dayDetail.ylr = '';
        ...
        if(isLuckyDay == 0){
          for(var b=0;b<dayList.length;b++){
            dayList[b].id=b;
            if (this.jFtv[SY] && this.jFtv[SY][SM+1] && (!((SY==this.tY)&&(SM ==this.tM)))) {
              for (var c = 0; c < this.jFtv[SY][SM + 1].length; c++) {
                if (dayList[b].ylr == this.jFtv[SY][SM + 1][c]) {
                  dayList[b].color = 'red';
            ...
            } else if (this.jFtv[SY] && this.jFtv[SY][SM+1] && ((SY==this.tY)&&(SM ==this.tM))){
              var num=null;
          ...
          for(var b=0,c=0;b<dayList.length;b++){
            ...
            if(!((SY==this.tY)&&(SM ==this.tM))){
              ...
              for(var j=0;j<luckyDay.length;j++){
                if(dayList[b].luckDay == luckyDay[j].luckyDay.substr(8,2)&& (b>=num)){
                  if(luckyDay[j].type == 1){
                    dayList[b].color ='#f7663c';
                  }else if(luckyDay[j].type == 2){
                    dayList[b].color ='#ecba36';
  ...
  .service('$chat',function($http,myUrl) {
    ...
    return{
      getRanking:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/ranking?appUserId=${data.appUserId}&businessId=${data.businessId}&qryType=${data.qryType}&qryType2=0&starttime=${data.starttime}&endtime=${data.endtime}`,config)
      ...
      getBusinessRanking:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/business/ranking?brandType=${data.brandType}&businessId=${data.businessId}&qryType=${data.qryType}&qryType2=${data.qryType2}&starttime=${data.starttime}&endtime=${data.endtime}&orderType=${data.orderType}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getChart:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/business/rank/chart?businessId=${data.businessId}&qryType=${data.qryType}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getYChart:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meeting/chart?businessId=${data.businessId}&qryType=${data.qryType}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getWChart:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/business/rank/chart/ext?businessId=${data.businessId}&qryType=${data.qryType}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getRankingList:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/ranking/list?appUserId=${data.appUserId}&businessId=${data.businessId}&qryType=${data.qryType}&qryType2=${data.qryType2}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getOrder:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/viporder?appUserId=${data.appUserId}&businessId=${data.businessId}&qryType=${data.qryType}&qryType2=${data.qryType2}&page=${data.page}&rows=${data.rows}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getCustom:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/addvip?appUserId=${data.appUserId}&businessId=${data.businessId}&qryType=${data.qryType}&qryType2=${data.qryType2}&page=${data.page}&rows=${data.rows}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getKt:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/business/kt/count?businessId=${data.businessId}&weekNum=${data.weekNum}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service('$operation',function($http,myUrl){
    ...
    return{
      ...
      YUnBook:function(data,callBackS,callBackE){
        ...
        $http
          .delete(`${url}/meeting/order?resvOrder=${data.resvOrder}&appUserId=${data.appUserId}&appUserPhone=${data.appUserPhone}&status=4&tableName=${data.tableName}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getYchangeSeat:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/meeting/prechange?resvDate='+data.resvDate+'&mealTypeId='+data.mealTypeId+'&businessId='+data.businessId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      payInfo:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/crm/table/bill?businessId='+data.businessId+'&tableId='+data.tableId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service('$httpClue',function($http,myUrl) {
    ...
    return {
      getMyClue:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/myKey?appUserId=${data.appUserId}&page=${data.page}&isAll=${data.isAll}&businessId=${data.businessId}&rows=${data.rows}&type=${data.type}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getRemindDetail:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/getRemindDetail?keyNo=${data.keyNo}&remindId=${data.remindId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getAppUserList:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/appUser/list?businessId=${data.businessId}&appUserId=${data.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getAppUserList1:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/appUser/list?businessId=${data.businessId}&appUserId=${data.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getAppUserNum:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/appUser/keyNum?businessId=${data.businessId}&isAll=${data.isAll}&isAll1=${data.isAll1}&appUserId=${data.appUserId}&resvDate=${data.resvDate}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getRemindList:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/getRemind/list?page=${data.page}&businessId=${data.businessId}&rows=${data.rows}&appUserId=${data.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getSearch:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/myKey?appUserId=${data.appUserId}&page=${data.page}&businessId=${data.businessId}&rows=${data.rows}&type=${data.type}&isSearch=${data.isSearch}&searchContent=${data.searchContent}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getSource:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/getSource?businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getSourceDetail:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/getSourceDetail?resvSourceId=${data.resvSourceId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getMouhuSource:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/getMouhuSource?businessId=${data.businessId}&phone=${data.phone}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getMouhuSource1:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/getMouhuSource1?businessId=${data.businessId}&phone=${data.phone}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service('$httpOrder',function($http,myUrl) {
    ...
    return {
      getSubmit:function(data, callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/submit/list?flag=${data.flag}&appUserId=${info.id}&businessId=${info.businessId}&mealTypeId=${data.mealTypeId}&starttime=${data.starttime}&endtime=${data.endtime}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getOrder:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/list?appUserId=${data.appUserId}&businessId=${data.businessId}&qryType=${data.qryType}&mealTypeId=${data.mealTypeId}&vipName=${data.vipName}&starttime=${data.starttime}&endtime=${data.endtime}&page=${data.page}&rows=${data.rows}&area=${data.area}&tableAreaId=${data.tableAreaId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getOrderQ:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/list?appUserId=&businessId=${data.businessId}&qryType=${data.qryType}&mealTypeId=${data.mealTypeId}&vipName=${data.vipName}&starttime=${data.starttime}&endtime=${data.endtime}&page=${data.page}&rows=${data.rows}&area=${data.area}&tableAreaId=${data.tableAreaId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getKe:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/customers/v2?businessId=${data.businessId}&batchNo=${data.batchNo}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getGuest:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/guests/v2?businessId=${data.businessId}&batchNo=${data.batchNo}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getMeetingGuests:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingManager/vip/indirect/list?hotelId=${data.hotelId}&orderBatchNo=${data.orderBatchNo}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      mohuKe:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/find/customer?appUserId=${data.appUserId}&businessId=${data.businessId}&customerPhone
=${data.customerPhone}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getUserStore:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/crm//user/store?appUserId=${data.appUserId}&businessId=${data.businessId}&date=${data.date}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getMeetingList:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meeting/resv/list?resvDate=${data.resvDate}&mealTypeId=${data.mealTypeId}&tableId=${data.tableId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getMeetingOrder:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/meetingKey/resv/order?businessId=${data.businessId}&isAll1=${data.isAll1}&isAll=${data.isAll}&resvDate=${data.resvDate}&resvStatus=${data.resvStatus}&appUserId=${data.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getBusinessInfo:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/business/meeting/info?businessId=${data.businessId}&appUserName=${data.surname||''}&appUserPhone=${data.username||''}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getDish:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/business/info?businessId=${data.businessId}&appUserName=${data.appUserName||''}&appUserPhone=${data.appUserPhone||''}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getTao:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/dish/templet?businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getDishDetail:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/dish/detail?businessId=${data.businessId}&zdbh=${data.id}&vipId=${data.vipId}&appUserId=${data.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service('$httpCustom',function($http,myUrl){
    ...
    return{
      ...
      'customValueList':function(data,callBackS, callBackE){
        ...
        console.log(data);
        $http
          .get(url+'/vip/value?businessId='+data.businessId+'&appUserId='+data.appUserId+'&type='+data.type+'&qryType='+data.qryType,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      customSubValueList:function (data, callBackS, callBackE) {
        ...
        $http
          .get(url+'/vip/detail/value/list?businessId='+data.businessId+'&appUserId='+data.appUserId+'&type='+data.type,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getNotices:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/notice/info?businessId=${data.businessId}&appUserId=${data.id}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      updateWxNotices:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/notice/update?businessId=${data.businessId}&noticeId=${data.noticeId}&type=${data.type}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      updateOrderNotice:function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/notice/updateNew?businessId=${data.businessId}&noticeId=${data.noticeId}&type=${data.type}&appUserId=${data.appUserId}&status=${data.status}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customZiyuan':function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/vip/notAllow?businessId='+data.businessId+'&appUserId='+data.appUserId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'leijiCustom':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/operatevip?appUserId=${data.appUserId}&businessId=${data.businessId}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'huanxingCustom':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/wakevip?appUserId=${data.appUserId}&businessId=${data.businessId}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customDetail':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/class/pu?id=${data.id}&appUserId=${data.appUserId}&businessId=${data.businessId}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customDetailYan':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/class/yan?id=${data.id}&appUserId=${data.appUserId}&businessId=${data.businessId}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customValueDetail':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/value/pu?id=${data.id}&appUserId=${data.appUserId}&businessId=${data.businessId}&type=${data.type}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      customSubValueDetail: function (data, callBackS, callBackE) {
        ...
        $http
          .get(`${url}/vip/detail/value?detailValue=${data.id}&appUserId=${data.appUserId}&businessId=${data.businessId}&type=${data.type}&firstClassValue=${data.firstClassValue||''}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customValueYanDetail':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/value/yan?id=${data.id}&appUserId=${data.appUserId}&businessId=${data.businessId}&type=${data.type}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customValueYanDetailNew':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/value/yan/new?&appUserId=${data.appUserId}&businessId=${data.businessId}&type=${data.type}&page=${data.page}&rows=${data.rows}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'selectCustom':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/search?appUserId=${data.appUserId}&businessId=${data.businessId}&searchText=${data.searchText}&type=${data.type}&all=${data.all}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'getCustomCount':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/count?appUserId=${data.appUserId}&businessId=${data.businessId}&vipId=${data.vipId}&type=${data.type}&qryType=${data.qryType}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'lastOrder':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/order/last?vipId=${data.vipId}&appUserId=${data.appUserId}&meetingStatus=${data.meetingStatus}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customGetDay':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/anniversary?vipId=${data.vipId}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customDayNow':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/anniversary/now?appUserId=${data.appUserId}&businessId=${data.businessId}&date=${data.date}&sysIntervalDay=${data.sysIntervalDay}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'saveSleepVipNotice':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/sleep/notice/save?appUserId=${data.appUserId}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customDayList':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/anniversary/list?appUserId=${data.appUserId}&businessId=${data.businessId}&date=${data.date}&sysIntervalDay=${data.sysIntervalDay}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customOrderListPu':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/list/vip/pu?page=${data.page}&rows=${data.rows}&vipId=${data.vipId}&appUserId=${data.appUserId}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'rankOrderListPu':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/list/seller/pu?page=${data.page}&businessId=${data.businessId}&rows=${data.rows}&appUserId=${data.appUserId}&qryType=${data.qryType}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'rankOrderListYan':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/list/seller/yan?page=${data.page}&businessId=${data.businessId}&rows=${data.rows}&appUserId=${data.appUserId}&qryType=${data.qryType}&starttime=${data.starttime}&endtime=${data.endtime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customOrderListAll':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/vip/all?page=${data.page}&rows=${data.rows}&vipId=${data.vipId}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      'customOrderListYan':function(data,callBackS, callBackE){
        ...
        $http
          .get(`${url}/order/list/vip/yan?page=${data.page}&rows=${data.rows}&vipId=${data.vipId}&appUserId=${data.appUserId}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service('$httpPsd',function($http,myUrl){
    ...
    return{
      ...
      loginCheck:function(data, callBackS){
        ...
        $http.get(url+'/business/login/list?appUserPhone='+data.appUserPhone, config)
          .success(function(data){
            callBackS(data);
        })
      },
      ...
      getCrmUser:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/crm/user/info?businessId='+data.businessId+'&phone='+data.key,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getCardList:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/crm/card/list?businessId='+data.businessId+'&memberKey='+data.memberID,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      next:function(data,callBackS, callBackE){
        ...
        var txt2=data.num;
        $http
          .get(url+'/password/code/chk?app_user_phone='+txt1+'&app_user_code='+txt2,config)
          .success(function(){
            callBackS();
          })
          .error(function(data,status){
      ...
      getCount:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/business/global/count?appUserId='+data.appUserId+'&businessId='+data.businessId+'&resvDate='+data.resvDate,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getCountA:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/business/global/count2?appUserId='+data.appUserId+'&businessId='+data.businessId+'&resvDate='+data.resvDate,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getSeat:function(data,callBackS,callBackE){
        ...
        console.log(data);
        $http
          .get(`${url}/business/tables?appUserId=${data.id}&businessId=${data.businessId}&resvDate=${data.resvDate}&isChangeTable=${data.isChangeTable}&mealTypeId=${data.mealTypeId}&tTypes=${data.tTypes}&minPeopleNum=${data.minPeopleNum}&maxPeopleNum=${data.maxPeopleNum}&minAmount=${data.minAmount}&maxAmount=${data.maxAmount}
          &mealTypeIdA=${data.mealTypeIdA}&mealTypeIdB=${data.mealTypeIdB}&peicai=${data.peicai}&tableAreaId=${data.tableAreaId}&status=${data.status}&confirm=${data.confirm}&kbc=${data.kbc}&fcb=${data.fcb}&page=${data.page}&rows=${data.rows}&sofa=${data.sofa}&television=${data.television}&washroom=${data.washroom}&relatedTable=${data.relatedTable || ''}&tableName=${data.tableName || ''}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getYSeat:function(data,callBackS,callBackE){
        ...
        console.log(data);
        $http
          .get(`${url}/business/meeting/tables?appUserId=${data.appUserId}&businessId=${data.businessId}&resvDate=${data.resvDate}&mealTypeId=${data.mealTypeId}&peicai=${data.peicai}&tableAreaId=${data.tableAreaId}&status=${data.status}&confirm=${data.confirm}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getYLook:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/business/meeting/look?businessId=${data.businessId}&appUserId=${data.appUserId}&startDate=${data.startDate}&endDate=${data.endDate}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getLuckyDay:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/meeting/luckyDay?businessId=${data.businessId}&luckyDay=${data.luckyDay}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      tableCheck:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/order/table/chk?appUserId=${data.appUserId}&businessId=${data.businessId}&resvDate=${data.resvDate}&mealTypeId=${data.mealTypeId}&checkedTableSet=${data.checkedTableSet}&mealTypeIdA=${data.mealTypeIdA}&mealTypeIdB=${data.mealTypeIdB}&kbc=${data.kbc}&fcb=${data.fcb}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      facilList:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/order/facil/list?businessId=${data.businessId}&resvDate=${data.resvDate}&mealTypeId=${data.mealTypeId}&mealTypeIdA=${data.mealTypeIdA}&mealTypeIdB=${data.mealTypeIdB}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      deleteCheck:function(data,callBackS){
        ...
        $http
          .get(`${url}/order/delete/occ?occIds=${data.occIds}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS();
          })
          .error(function(data,status){
      ...
      $http
        .get(`${url}/order/notice/num?businessId=${data.businessId}&appUserId=${data.id}`,config)
        .success(function(data){
          callBackS(data);
        })
        .error(function(data,status){
      ...
      getAccessToken:function(callBackS, callBackE){
        ...
        $http
          .post(`${ydurl}/auth/oauth/token?grant_type=password&scope=server&username=13777575146&password=123456&auth_username=13777575146`,"",config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      tableYCheck:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/meeting/table/chk?resvDate=${data.resvDate}&mealTypeId=${data.mealTypeId}&checkedTableSet=${data.checkedTableSet}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      mohuSelect:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/vip/mohu?appUserId=${appId}&vipPhone=${data.vipPhone}&businessId=${data.businessId}&date=${data.date}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      crmSelect:function(data,callBackS,callBackE){
        ...
        var appId=data.appUserId;
        $http
          .get(`${url}/vip/crm/user?appUserId=${appId}&vipPhone=${data.vipPhone}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getVipCardList:function(data,callBackS,callBackE){
        ...
        var appId=data.appUserId;
        $http
          .get(`${url}/crm/store/vip/ticket?appUserId=${appId}&beginTime=${data.beginTime}&endTime=${data.endTime}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getVipWine:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/vip/wine/list?vipPhone=${data.vipPhone}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getVipAppraise:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/vip/appraise?vipPhone=${data.vipPhone}&businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getSleepVipList:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/vip/sleep/vip?appUserId=${data.appUserId}&businessId=${data.businessId}&createTime=${data.createTime}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
        ...
        $http
          .get(`${url}/vip/reorder?appUserId=${data.appUserId}&vipPhone=${data.vipPhone}&businessId=${data.businessId}&resvDate=${data.resvDate}&mealTypeId=${data.mealTypeId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      vipLastBack:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/meeting/vip/callon?businessId=${data.businessId}&vipPhone=${data.vipPhone}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      changeTableLog:function(tableData,callBackS,callBackE){
        ...
        $http
          .get(`${url}/business/changeTables?businessId=${tableData.businessId}&resvDate=${tableData.resvDate}&mealTypeId=${tableData.mealTypeId}&mealTypeIdA=${tableData.mealTypeIdA}&mealTypeIdB=${tableData.mealTypeIdB}&tableId=${tableData.tableId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getWeddingCompany:function(data,callBackS,callBackE){
        ...
        $http
          .get(`${url}/meeting/weddingCompany?businessId=${data.businessId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getReason:function(data,callBackS,callBackE){
          ...
          $http
            .get(`${url}/order/unorder/reason?businessId=${data.businessId}`,config)
            .success(function(data){
              callBackS(data);
            })
            .error(function(data,status){
      ...
      getCodeUrl:function(data,callBackS,callBackE){
        ...
        $http.get(`${ydurl}/ydservice/wechat/code/ticket?sceneStr=${data.phone}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getTodayRemind:function(data,callBackS,callBackE){
        ...
        $http.get(`${url}/meetingKey/getRemind/list/day?appUserId=${data.appUserId}&remindDate=${data.remindDate}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getUserNameAndPwd:function(data,callBackS,callBackE){
        ...
        $http.get(`${url}/user/appuser?appUserId=${data.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      getInternationalConfig:function(callBackS,callBackE){
        ...
        $http.get(`${url}/order/internationalConfig`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service('$shopping',function ($http,myUrl) {
    ...
    return{
      ...
      shopAddress:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/customer/express/address?appUserId='+data.id+'&businessId='+data.businessId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      receiptAddress:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/customer/receipt/info?appUserId='+data.id+'&businessId='+data.businessId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      businessInfo:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/business/express/info?businessId='+data.businessId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      myOrder:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/orders/my?appUserId='+data.id+'&businessId='+data.businessId,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
      ...
      orderDetail:function(data,callBackS, callBackE){
        ...
        $http
          .get(url+'/orders/detail?appUserId='+data.appUserId+'&businessId='+data.businessId+'&orderNo='+data.orderNo,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data,status){
  ...
  .service("$httpWechat", function ($http,myUrl) {
    ...
    return {
      ...
      getMOrderData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/meeting/get/order/data?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getMNewKeyData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/meeting/get/new/key?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getMNewOrderData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/meeting/get/new/order?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}&status=${params.status}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getMNewRecordData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/meeting/get/new/record?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getMRecordRankData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/meeting/get/record/rank?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getWechatOrderInfo: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/meeting/get/order/data/appUser?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}&appUserId=${params.appUserId}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getOrderData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/order/data?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getOrderStatisticsData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/order/statistics?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getOrderRankData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/table/rank?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getOrderListData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/callon/list?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getSellerRankData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/seller/rank?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}&sort=${params.sort}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getVipValueData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/vip/value?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getVipValueDetailData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/vip/value/detail?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getVipRankAllData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/vip/rank/all?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getVipRecordData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/vip/change/record?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
      ...
      getVipAddRankData: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/vip/add?businessId=${params.businessId}&startResvdata=${params.startResvdata}&endResvdata=${params.endResvdata}`,config)
          .success(function(data){
            callBackS(data);
          })
          .error(function(data){
  ...
  .service("$httpCunjiu", function ($http,myUrl) {
    ...
    return {
      getWineVip: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/store/wine/vip?businessId=${params.businessId}&type=${params.type}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
      ...
      getVipWines: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/store/wine/list?businessId=${params.businessId}&phone=${params.phone}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
      ...
      getWineLogs: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/store/wine/logs?businessId=${params.businessId}&phone=${params.phone}&vipId=${params.vipId}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
      ...
      getVipHasWine: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/store/wine/has?businessId=${params.businessId}&phone=${params.phone}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
  ...
  .service("$httpLock", function ($http,myUrl) {
    ...
    return {
      ...
      unLockYorder: function (params, callBackS, callBackE) {
        $http
          .put(`${url}/meeting/unlock/order?resvOrder=${params.resvOrder}&appUserId=${params.appUserId}`,params,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
      ...
      unLockYorderAll: function (params, callBackS, callBackE) {
        $http
          .put(`${url}/meeting/unlock/batch/order?resvOrder=${params.resvOrder}&appUserId=${params.appUserId}&isRelated=${params.isRelated}`,params,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
  ...
  .service("$httpGroup", function ($http,myUrl) {
    ...
    return {
      getGroupOrder: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/group/meal/order?businessId=${params.businessId}&resvStartDate=${params.resvStartDate}&resvEndDate=${params.resvEndDate}&mealTypeId=${params.mealTypeId}&groupMealId=${params.groupMealId}&appUserId=${params.appUserId}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
      ...
      getGroupMeal: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/group/meal/num?businessId=${params.businessId}&resvStartDate=${params.resvStartDate}&resvEndDate=${params.resvEndDate}&mealTypeId=${params.mealTypeId}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
      ...
      getGroupOrderDetail: function (params, callBackS, callBackE) {
        $http
          .get(`${url}/order/get/group/meal/detail?businessId=${params.businessId}&resvOrder=${params.resvOrder}`,{
            headers:{
              'Content-Type':'application/x-www-form-urlencoded',
              'Authorization': localStorage['TOKEN_KEY']
            }
